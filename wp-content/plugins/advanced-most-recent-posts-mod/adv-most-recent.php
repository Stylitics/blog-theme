	...
	*/
		...
		foreach ($posts as $post) {
			...
			$category=get_the_category($post->ID);
 			$postlist .= '<div class="post long r'.$recent_count.'"><div class="type"><span>'.$category[0]->cat_name.'</span></div><a href="'. get_permalink($post->ID).'">'.get_the_post_thumbnail($post->ID, 'recent-posts', array('class'=>'post-img')).'<h3 class="title">'.$post_title.'</h3></a></div>';
