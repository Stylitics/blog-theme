       ...
       extract($args); 
        ...
        echo $before_widget;
            echo $before_title . $title . $after_title;
             ...
             $c_date = the_date( 'd-F', '', '', false );
             $c_date = explode("-", $c_date);
             ?>
            <li class="post">
                 <?php if ( has_post_thumbnail() ){ the_post_thumbnail('fashion-history-slider', array('class'=>'post-img')); } ?>
                <div class="post-content">
                    <div class="time">
                        <span class="month"><?php echo $c_date[1]; ?></span> <br/>
                        <span class="day"><?php echo $c_date[0]; ?><sup>th</sup></span>
                    </div>
                    <div class="container">
                        <p class="excerpt"><?php echo substr(get_the_excerpt(), 0, 150); ?></p>
