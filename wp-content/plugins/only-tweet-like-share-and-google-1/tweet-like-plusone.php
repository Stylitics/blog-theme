...
$s4link= '<div class="socialicons s4fblike" style="float:left;margin-right: 10px;"><div id="fb-root"></div>'.$flsc.'<fb:like href="'.$plink.'" send="'.$snd.'"'.$tp.'show_faces="false" font=""></fb:like></div>';
$sharelinks.=$s4link;
$btnarr[2]=$s4link;
}
